...
func initFlags(flags *flag.FlagSet) {
	...
	flags.String("apiHost", "0.0.0.0", "API-host where Mailpie serves ths API - Use 127.0.0.1 for local access & 0.0.0.0 for network access")
	...
	flags.Int("apiPort", 8001, "API-port where Mailpie serves ths API")
